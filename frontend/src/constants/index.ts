...
// TRANSACTION
export const ADD_TRANSACTION_FORM = 'ADD_TRANSACTION_FORM';
export type ADD_TRANSACTION_FORM = typeof ADD_TRANSACTION_FORM;

export const REMOVE_TRANSACTION_FORM = 'REMOVE_TRANSACTION_FORM';
export type REMOVE_TRANSACTION_FORM = typeof REMOVE_TRANSACTION_FORM;

export const FETCH_TRANSACTIONS = 'FETCH_TRANSACTIONS';
export type FETCH_TRANSACTIONS = typeof FETCH_TRANSACTIONS;

export const CREATE_TRANSACTIONS = 'CREATE_TRANSACTIONS';
export type CREATE_TRANSACTIONS = typeof CREATE_TRANSACTIONS;

export const DELETE_TRANSACTIONS = 'DELETE_TRANSACTIONS';
export type DELETE_TRANSACTIONS = typeof DELETE_TRANSACTIONS;

export const UPDATE_TRANSACTIONS = 'UPDATE_TRANSACTIONS';
export type UPDATE_TRANSACTIONS = typeof UPDATE_TRANSACTIONS;
